...
class AppPallete {
  ...
  static const Color primaryLightest = Color(
    0xFFF5F3FF,
  ); // Purple 50 - Lightest purple
  ...
  static const Color accentLighter = Color(
    0xFFCCFBF1,
  ); // Teal 100 - Lightest teal
